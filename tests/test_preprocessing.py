...
sys_path.append("../src")
from elasticity.data.preprocessing import round_price_effect, process_data

def test_round_price_effect():
...
def test_process_data():
    ...
    df_full = pd.DataFrame({
        "conversions_most_common_shelf_price": [9.54, np.nan, 15.82, np.nan, np.nan],
    ...
    expected_result = pd.DataFrame({
        ...
        "source": ["conversions", "views", "conversions", "price_recommendations", "price_recommendations"]
    })
